...
client = OpenAI(
    base_url=ENDPOINT_URL,  # e.g., "https://YOUR_ID.eu-west-1.aws.endpoints.huggingface.cloud/v1"
    api_key=HF_TOKEN        # e.g., "hf_XXXXX"
)
...
def generate_fable(character, trait, setting, conflict, resolution, moral):
    ...
    completion_stream = client.completions.create(
        model="Llama-3.1-8B-Instruct",  # or your model name
        prompt=prompt_text,
        max_tokens=300,
